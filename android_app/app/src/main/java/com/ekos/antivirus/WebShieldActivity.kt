    ...
    private fun performUrlAnalysis(url: String) {
        ...
        lifecycleScope.launch {
            ...
            if (result.isSafe) {
                ...
                tvVerdict.setTextColor(ContextCompat.getColor(this@WebShieldActivity, R.color.status_green_light))
                cardResult.strokeColor = ContextCompat.getColor(this@WebShieldActivity, R.color.status_green)
            } else {
                tvVerdict.text = "DİKKAT: ZARARLI VEYA OLTALAMA LİNKİ"
                tvVerdict.setTextColor(ContextCompat.getColor(this@WebShieldActivity, R.color.status_red_light))
                cardResult.strokeColor = ContextCompat.getColor(this@WebShieldActivity, R.color.status_red)
            }
